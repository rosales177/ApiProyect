...
//     {
//         for ($i=0; $i <br count($columnsfilter) ; $i++) { 
...
//         $sql = $sql.' '.$clause.' ';   
//         for ($i=0; $i <br count($expretion)-1 ; $i++) { 
//             $sql = $sql . $expretion[$i] ;
//         }
...
include "./src/App/Settings.php";
echo PATH_URL_DIR_IMAGE_USER.'</br>';
echo PATH_URL_DIR_IMAGE_PROD.'</br>';
// echo PATH_ROOT .'</br>';
// echo PATH_DIRECTORY.'</br>';
// echo PATH_IMG_USER.'</br>';
// echo PATH_IMG_PRODT.'</br>';
